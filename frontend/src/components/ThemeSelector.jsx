...
const ThemeSelector = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="flex flex-col border border-violet-100 sm:flex-row items-start sm:items-center mb-8 justify-between gap-4 p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl">
        <Tabs tabs={TAB_DATA} activeTab={tabValue} setActiveTab={setTabValue} />
        <button
          onClick={handleThemeSelection}
          className="w-full sm:w-auto flex items-center justify-center text-white font-black rounded-2xl hover:scale-105 transition-all shadow-lg hover:shadow-xl gap-3 px-6 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600"
        >
          <Check size={18} />
          Apply Changes
        </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
        ...
        {/* RIGHT AREA  */}
        <div
          className="lg:col-span-3 bg-white rounded-2xl border border-gray-100 sm:p-6"
          ref={resumeRef}
        >
        <RenderResume

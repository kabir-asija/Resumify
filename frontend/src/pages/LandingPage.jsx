          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <h1 className={landingPageStyles.heading}>
                <div className={landingPageStyles.headingText}>Craft</div>
                <div className={landingPageStyles.headingGradient}>
                  Advanced
                </div>
                <div className={landingPageStyles.headingText}>Resumes</div>
              </h1>

              <p className={landingPageStyles.description}>
                Create stunning resumes effortlessly with Resumify's ATS
                friendly templates. Stand out to employers and land your dream
                job today!
              </p>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  Join thousands of successful job seekers using Resumify to
